...
if __name__ == "__main__":
    ...
    # predict using model trained up to # epochs
    epoch = 750
    ...
    for T in [26, 51]:
        fname = '_output/vae_sjdf_test_{:02d}_{:04d}.npy'.format(T, epoch)
        ...
        fname = '_output/etamax_VAE_predict_{:02d}m.txt'.format(minutes)
